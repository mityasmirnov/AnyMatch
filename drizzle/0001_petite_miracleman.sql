...
--> statement-breakpoint
DROP INDEX `group_user_idx` ON `group_members`;--> statement-breakpoint
DROP INDEX `users_openId_unique` ON `users`;--> statement-breakpoint
ALTER TABLE `group_members` MODIFY COLUMN `joinedAt` timestamp NOT NULL DEFAULT (now());--> statement-breakpoint
...
ALTER TABLE `group_members` ADD PRIMARY KEY(`id`);--> statement-breakpoint
ALTER TABLE `users` ADD PRIMARY KEY(`id`);--> statement-breakpoint
ALTER TABLE `users` ADD `photoUrl` text;--> statement-breakpoint
ALTER TABLE `group_members` ADD CONSTRAINT `group_user_idx` UNIQUE(`groupId`,`userId`);--> statement-breakpoint
